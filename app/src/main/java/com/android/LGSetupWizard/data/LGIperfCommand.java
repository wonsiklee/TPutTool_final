...
public class LGIperfCommand {
    ...
    public LGIperfCommand(String command){
        ...
        if (DBG) {
            Log.d(TAG, "commandOptions = ");
            for (int i = 0; i < commandOptions.length; i++)
                Log.d(TAG, "       " + commandOptions[i]);
        }
        ...
        for(int i =0; i < commandOptions.length ; i++){
            switch(commandOptions[i]){
                ...
                case "-t":
                    ...
                    if (DBG) Log.d(TAG, "-t value = "+commandOptions[i] +">> " + Integer.valueOf(commandOptions[i]) );
                ...
                case "-i" :
                    ...
                    if (DBG) Log.d(TAG, "-i value = "+commandOptions[i] +">> " + Integer.valueOf(commandOptions[i]) );
