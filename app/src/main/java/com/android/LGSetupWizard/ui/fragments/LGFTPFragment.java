...
public class LGFTPFragment extends Fragment implements View.OnKeyListener, AdapterView.OnItemClickListener, Dialog.OnDismissListener, View.OnFocusChangeListener, ILGTestTestFragment {
    ...
    public LGFTPTestFlowConfigurationInfo getTestConfigurationInfo() {
        ...
        info.setSelectedFileList(this.mFTPFileListVIewAdapter.getSelectedFileList());
        return info;
    }
            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        mTestStateListener.onTestFinished();
                    }
                }
            }.start();
        }
    ...
    public class LGFTPTestFlowConfigurationInfo extends LGTestFlowConfigurationInfo {
        ...
        @Getter @Setter private ArrayList<LGFTPFile> mSelectedFileList;
